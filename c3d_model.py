...
def build_model():
    ...
    model = keras.models.Sequential([
        keras.layers.Convolution3D(64, (3,3,3), activation='relu', padding='same', name='conv1', input_shape=input_shape),
        keras.layers.MaxPooling3D(pool_size=(1, 2, 2), strides=(1, 2, 2), padding='valid', name='pool1'),
        keras.layers.Convolution3D(128, (3,3,3), activation='relu', padding='same', name='conv2'),
        keras.layers.MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2), padding='valid', name='pool2'),
        keras.layers.Convolution3D(256, (3,3,3), activation='relu', padding='same', name='conv3a'),
        keras.layers.Convolution3D(256, (3,3,3), activation='relu', padding='same', name='conv3b'),
        keras.layers.MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2), padding='valid', name='pool3'),
        keras.layers.Convolution3D(512, (3,3,3), activation='relu', padding='same', name='conv4a'),
